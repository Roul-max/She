...
import { User, Mail, Lock, UserPlus, BarChart3 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 animate-fadeInUp">
      <div className="max-w-md w-full space-y-8 animate-slideInRight">
        <div className="text-center animate-bounce-custom">
          ...
          <p className="mt-2 text-gray-600">Create your intern portal account</p>
        </div>

        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100 animate-slideInLeft hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
